"""Table 2 — best 모델의 클래스별 성능, 9줄.

열: class_name | gt_count | pred_count | mIoU | AP20
출처: best 조합·merge×1 예측 JSON (table_common). 최고 모델(Mask2Former Swin-L) 기준.
"""
import os
import sys
import glob
...
class Table2Builder:
    """클래스별 gt/pred 개수 + mIoU + AP20을 집계한다."""
